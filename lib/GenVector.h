...
typedef void (*ElemDestroy)(void *_item);
 ...
 * @return void
 */
void VectorDestroy(Vector **_vector, ElemDestroy _elementDestroy);
 ...
 * @retval VECTOR_UNITIALIZED_ERROR if either given pointer is null
 * @retval VECTOR_OVERFLOW_ERROR if block size is 0
 * @retval VECTOR_REALLOCATION_ERROR if failed to increase the size of the vector
 */
 ...
 * @retval VECTOR_SUCCESS on success 
 * @retval VECTOR_UNITIALIZED_ERROR if either given pointer is null
 * @retval VECTOR_UNDERFLOW_ERROR if the number of items is 0
 ...
 * @retval VECTOR_SUCCESS on success 
 * @retval VECTOR_UNITIALIZED_ERROR if either given pointer is null
 * @retval VECTOR_INDEX_OUT_OF_BOUNDS_ERROR if the index number is invalid
 */
 ...
 * @warning returns 0 if given pointer is NULL	
 */
