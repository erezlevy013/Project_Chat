 ...
 * @retval LIST_ALLOCATION_ERROR on memory allocation failure when creating node
 */
 ...
 *
 * @params _list A previously created List ADT returned via ListCreate
 * @params _data An item to add to the list
 * @returns LIST_SUCCESS on success
 * @retval LIST_UNINITIALIZED_ERROR if the list is not initialized
 * @retval LIST_NULL_ELEMENT_ERROR  if _item is NULL
 * @retval LIST_ALLOCATION_ERROR on memory allocation failure when creating node
 */
 ...
 *
 * @params _list : A previously created List ADT returned via ListCreate
 * @params _pItem: To store a pointer of the removed item from the list
 * @returns LIST_SUCCESS on success
 * @retval LIST_UNINITIALIZED_ERROR if the list is not initialized
 * @retval LIST_NULL_ELEMENT_ERROR  if _item is NULL
 ...
 *
 * @params _list : A previously created List ADT returned via ListCreate
 * @returns the number of elements in the list, 0 if given pointer is null or if list is empty
 */
